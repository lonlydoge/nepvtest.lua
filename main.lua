...
if Humanoid.RigType == Enum.HumanoidRigType.R15 then
    game.StarterGui:SetCore("ChatMakeSystemMessage", {
        Text = "[lonHub] You are on R15! Please use the R15 Reanimation instead.",
        Color = Color3.fromRGB(255, 10, 70),
        TextSize = 18,
        Font = Enum.Font.Ubuntu
    });
return end
if game.Players.LocalPlayer.Character:FindFirstChild("lonHub") or workspace:FindFirstChild("lonHub") then
    game.StarterGui:SetCore("ChatMakeSystemMessage", {
        Text = "[lonHub] You are already reanimated! Please reset to unreanimate.",
        Color = Color3.fromRGB(255, 10, 70),
        TextSize = 18,
        Font = Enum.Font.Ubuntu
    });
...
game:WaitForChild("Run Service").Heartbeat:Connect(function()
    if Reanimated == true then
        if Character.lonHub then
            Character.Torso.CFrame=Character.lonHub.Torso.CFrame
        end
...
CopyCharacter.Name = "lonHub" -- you can always change name.

for k,l in pairs(Character.lonHub:GetDescendants()) do 
...
game:GetService("UserInputService").JumpRequest:connect(function(t)
    if CopyCharacter.Humanoid.FloorMaterial~=Enum.Material.Air then 
        ...
        game.Players.LocalPlayer.Character.lonHub:FindFirstChildOfClass('Humanoid').Sit=false 
    end 
end)
...
for i,v in pairs(mas:GetChildren()) do
	v.Parent = game:GetService("Players").LocalPlayer.Character.lonHub
...
Character=Player.Character.lonHub
...
Align(Hat.Handle,AlignChar.lonHub.Model.Part,Vector3.new(0,-0.1,0),Vector3.new(0,90,60))
